            ...
            <form action="" method="POST" id="formulario">
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input class="form-control" id="av1" name="av1" placeholder="Nota av1" pattern="[0-1]?[0-8][.][0-9][0-9]"/>
                    </div>
                    <div class="col form-group">
                        <label for="av2">Av2</label>
                        <input class="form-control" id="av2" name="av2" placeholder="Nota av2" pattern="[0-1]?[0-8][.][0-9][0-9]"/>
                    </div>
                    <div class="col form-group">
                        <label for="av3">Av3</label>
                        <input class="form-control" id="av3" name="av3" placeholder="Nota av3" pattern="[0-1]?[0-8][.][0-9][0-9]"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col form-group">
                        <label for="aps1">Aps1</label>
                        <input class="form-control" id="aps1" name="aps1" placeholder="Nota aps1" pattern="[0-1]?[0-8][.][0-9][0-9]"/>
                    </div>
                    <div class="col form-group">
