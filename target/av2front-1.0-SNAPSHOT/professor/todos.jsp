<%-- 
    Document   : todos
    Created on : 29 de out de 2020, 14:08:26
    Author     : eff
--%>
...
<%@page language="java" import="com.av2front.BancoConexao"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Mostrar todos os professores</title>
    </head>
    <body>
        <% 
        try{
            ...
            ResultSet resultado = consulta.executeQuery("select * from professor");
